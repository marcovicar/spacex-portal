...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-10 space-y-16 pt-24">
      {/* Main section */}
      <section className="text-center space-y-4 pt-16">
        <h1 className="text-5xl font-bebas uppercase tracking-widest animate-in slide-in-from-bottom fade-in duration-700">
